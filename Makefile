# Personal Knowledge Context Graph Application
...
start:
	@echo "Starting Personal Knowledge Context Graph..."
	@trap 'kill 0' EXIT; \
		$(MAKE) dev-backend & \
		$(MAKE) dev-frontend & \
		wait
...
# MCP Server for Claude Desktop (bolt backend)
