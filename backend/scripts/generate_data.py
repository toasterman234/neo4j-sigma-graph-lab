"""Generate sample data for Personal Knowledge context graph."""
...
async def main():
    print("Seeding Personal Knowledge context graph...")
    ...
    await close_neo4j()
    print("\nDone! Your Personal Knowledge context graph is ready.")
